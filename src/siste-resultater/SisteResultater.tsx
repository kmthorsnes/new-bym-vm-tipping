  ...
  return (
    <table className="table-auto">
      ...
      <tbody>
        ...
        <SisteResultatKort hjemmelag="Kamerun" hjemmelagScore={0} bortelag="Brasil" bortelagScore={0} />
        <SisteResultatKort hjemmelag="Serbia" hjemmelagScore={0} bortelag="Tyskland" bortelagScore={0} />
      </tbody>
    </table>
  );
};
